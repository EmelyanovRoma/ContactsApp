...
namespace ContactsApp.UnitTests
{
    ...
    public class ProjectTest
    {
        ...
        public void FindContactsBySubstring_FindContacts_ReturnsFindedContacts()
        {
            // Arrange
            var project = new Project();
            var firstContact = new Contact();
        ...
        public void FindContactsBySunstring_FindContactsByEmptySubstring_ReturnsAllContacts()
        {
            // Arrange
            var project = new Project();
            var firstContact = new Contact();
